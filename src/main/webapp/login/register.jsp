                        ...
                        <form class="user" action="${pageContext.request.contextPath}/register" method="post">
                            ...
                            <div class="form-group row">
                                <div class="col-sm-6 mb-3 mb-sm-0">
                                    <input type="text" class="form-control form-control-user" name="name" id="InputName" placeholder="Nazwa użytkownika">
                                </div>
                            </div>
                            ...
                            <div class="form-group row">
                                <div class="col-sm-6 mb-3 mb-sm-0">
                                    <input type="password" name="password" class="form-control form-control-user" id="InputPassword" placeholder="Hasło">
                                </div>
                            </div>
